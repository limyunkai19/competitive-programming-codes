// LCA implemented using 2^k parent table
// Solve UVa Online Judge problem, 12238 - Ants Colony
// link: https://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&category=24&page=show_problem&problem=3390
